...
import PropTypes from "prop-types"
 class AddProjectTask extends Component {
     ...
     onSubmit(e)
     {
         ...
         console.log(newTask);
         this.props.addProjectTask(this.state.projectIdentifir,newTask,this.props.history);
     }
            ...
            <div className="col-md-8 m-auto">
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    {/* <div className="form-group">
                        ...
                        placeholder="Backlog Description" name="backlogDescription" 
                        value={this.state.backlogDescription}
